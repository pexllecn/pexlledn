...
export const metadata: Metadata = {
  title: "Alert, Notification, and Banner Components",
  description:
...
export default function Page() {
  return (
    <ContentLayout title="Inputs">
      <main>
        <div className="px-4 sm:px-6">
          <div className="mx-auto w-full max-w-6xl">
            <PageHeader title="Alert, Notification, and Banner"> </PageHeader>
