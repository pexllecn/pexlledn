                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="mb-6">
                        ...
                        <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                          <li>
                            Design and implement user-centered interfaces for
                          ...
                          <li>
                            Execute all visual design stages from concept to
                            final hand-off to engineering.
                          </li>
                          <li>
                            Conceptualize original ideas that bring simplicity
                            and user friendliness to complex design roadblocks.
                          </li>
                          <li>
                            Create wireframes, storyboards, user flows, process
                            flows and site maps to effectively communicate
                      ...
                      <div className="mb-6">
                        ...
                        <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                          ...
                          <li>
                            Ability to present your designs and sell your
                          ...
                          <li>
                            Up-to-date with the latest UI/UX trends, techniques,
                            and technologies.
                          </li>
                        </ul>
                      </div>
