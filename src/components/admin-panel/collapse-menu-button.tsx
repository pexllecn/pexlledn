    ...
    >
      <CollapsibleTrigger className="w-full mb-1 cursor-pointer" asChild>
        <Button
          ...
          className={cn(
            "w-full justify-start h-8 mb-1 px-3 py-1 hover:bg-black/[0.06] dark:hover:bg-white/[0.08] ",
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <DropdownMenuTrigger asChild>
              <Button
                variant={active ? "outline3" : "ghost"}
                className="w-full justify-start h-8 mb-1 hover:bg-black/[0.06] dark:hover:bg-white/[0.08] p-3 text-muted-foreground"
              >
                <div className="w-full items-center flex justify-between">
                  <div className="flex items-center">
                    <span
