...
const badgeVariants = cva(
  "inline-flex items-center justify-center rounded-md border px-1.5 text-xs font-medium leading-normal outline-offset-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-ring/70",
  {
    variants: {
      variant: {
        default:
