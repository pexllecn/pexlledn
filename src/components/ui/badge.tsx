...
const badgeVariants = cva(
  "inline-flex items-center justify-center rounded-full border px-1.5 text-xs font-medium leading-normal outline-offset-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-ring/70",
  {
    variants: {
      variant: {
        default:
        ...
        primary:
          "border-transparent bg-primary/20 border-primary/10 text-spcolor dark:text-primary font-medium",
        secondary:
        ...
        outline2:
          "border-transparent bg-primary/20 border-primary/10 text-spcolor",
        success:
