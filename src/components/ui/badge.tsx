...
const badgeVariants = cva(
  "inline-flex items-center justify-center rounded-full border px-1.5 text-xs font-medium leading-normal transition-colors outline-offset-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-ring/70",
  {
    variants: {
      variant: {
        default: "border-transparent bg-primary text-primary-foreground dark:shadow",
        primary:
        ...
        success: "border-transparent bg-emerald-500/10 border-emerald-500/20 text-emerald-500",
        decline: "border-transparent bg-red-500/10 border-red-500/20 text-red-500",
