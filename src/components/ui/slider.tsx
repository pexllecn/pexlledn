...
>(({ className, showTooltip = false, tooltipContent, ...props }, ref) => {
  ...
  return (
    <SliderPrimitive.Root
      ...
      {...props}
    >
      <SliderPrimitive.Track className="relative grow overflow-hidden rounded-full bg-primary/30 data-[orientation=horizontal]:h-1 data-[orientation=vertical]:h-full data-[orientation=horizontal]:w-full data-[orientation=vertical]:w-1">
